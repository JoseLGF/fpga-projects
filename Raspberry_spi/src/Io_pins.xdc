...
#set_property IOSTANDARD LVCMOS33 [get_ports {USER_LED[8]}]
...
#set_property IOSTANDARD LVCMOS33 [get_ports {led[8]}]
set_property PACKAGE_PIN J1 [get_ports RPI_CLK]
set_property IOSTANDARD LVCMOS33 [get_ports RPI_CLK]
set_property PACKAGE_PIN G2 [get_ports RPI_MISO]
set_property IOSTANDARD LVCMOS33 [get_ports RPI_MISO]
set_property PACKAGE_PIN L2 [get_ports RPI_MOSI]
set_property IOSTANDARD LVCMOS33 [get_ports RPI_MOSI]
set_property PACKAGE_PIN J2 [get_ports RPI_SS]
set_property IOSTANDARD LVCMOS33 [get_ports RPI_SS]
