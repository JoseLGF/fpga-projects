...
#
# gen_proj.tcl: Tcl script for re-creating project 'picoblaze'
#
# Generated by Vivado on Sun Apr 19 00:42:49 -0500 2020
...
#
# 1. This project restoration tcl script (gen_proj.tcl) that was generated.
#
...
set script_file "gen_proj.tcl"

# Create project
create_project "picoblaze" "./work/picoblaze" -part xc7a35tcpg236-1
...
set file "$origin_dir/src/hdl/sseg_dec.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set file "$origin_dir/src/psm/unsigned_multiplier.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "pico_top" -objects $obj
...
puts "INFO: Project created: picoblaze"
